...
(defn ->SecureHandlerWithClientCert
  ...
  (case [record-support? lazy-request-map?]
    ...
    [true false] (SyncHandler. host port handler response/send-record-exchange-response request/get-https-client-cert-exchange-request-map handler/get-exchange-response)
    [false true] (LazyReqSyncHandler. host port handler response/send-exchange-response handler/get-exchange-response)
    [false false] (SyncHandler. host port handler response/send-exchange-response request/get-https-client-cert-exchange-request-map handler/get-exchange-response)))

(defn ->AsyncSecureHandlerWithClientCert
  [host port handler record-support? lazy-request-map?]
  ...
  (case [record-support? lazy-request-map?]
    ...
    [true false] (AsyncHandler. host port handler request/get-https-client-cert-exchange-request-map response/create-async-record-response)
    [false true] (LazyReqAsyncHandler. host port handler response/create-async-response)
    [false false] (AsyncHandler. host port handler request/get-https-client-cert-exchange-request-map response/create-async-response)))