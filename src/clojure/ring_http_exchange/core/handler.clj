...
(deftype LazyReqAsyncHandler [host port handler executor create-response-fn request-map-fn]
  HttpHandler
  (handle [_ exchange]
    (handler/get-async-exchange-response
      handler
      executor
      (request-map-fn exchange)
      (create-response-fn exchange))))
...
(defn async-not-secure-handler
  [host port handler executor record-support? lazy-request-map?]
  (case [record-support? lazy-request-map?]
    [true true] (LazyReqAsyncHandler. host port handler executor response/create-async-record-response request/->LazyHttpRequest)
    [true false] (AsyncHandler. host port handler executor response/create-async-record-response request/get-http-exchange-request-map)
    [false true] (LazyReqAsyncHandler. host port handler executor response/create-async-response request/->LazyHttpRequest)
    [false false] (AsyncHandler. host port handler executor response/create-async-response request/get-http-exchange-request-map)))
...
(defn async-secure-handler
  [host port handler executor record-support? lazy-request-map?]
  (case [record-support? lazy-request-map?]
    [true true] (LazyReqAsyncHandler. host port handler executor response/create-async-record-response request/->LazyHttpsRequest)
    [true false] (AsyncHandler. host port handler executor response/create-async-record-response request/get-https-exchange-request-map)
    [false true] (LazyReqAsyncHandler. host port handler executor response/create-async-response request/->LazyHttpsRequest)
    [false false] (AsyncHandler. host port handler executor response/create-async-response request/get-https-exchange-request-map)))
...
(defn async-secure-handler-with-certs
  [host port handler executor record-support? lazy-request-map?]
  (case [record-support? lazy-request-map?]
    [true true] (LazyReqAsyncHandler. host port handler executor response/create-async-record-response request/->LazyHttpsClientCertRequest)
    [true false] (AsyncHandler. host port handler executor response/create-async-record-response request/get-https-client-cert-exchange-request-map)
    [false true] (LazyReqAsyncHandler. host port handler executor response/create-async-response request/->LazyHttpsClientCertRequest)
    [false false] (AsyncHandler. host port handler executor response/create-async-response request/get-https-client-cert-exchange-request-map)))